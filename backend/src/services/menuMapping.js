// ─── Menu Language Mappings ────────────────────────────────────────────────────
// For each item: canonical name + all aliases in Hindi, English, Hinglish
// Used by the voice bot to match spoken input to menu items.

/**
 * @typedef {Object} MenuAlias
 * @property {string} food_name - canonical name (must match backend menu exactly)
 * @property {string} category
 * @property {number} price
 * @property {string[]} aliases - all recognized spoken forms (lowercase)
 */
...
export const MENU_ALIASES = [
  ...
  // ── Beverages ──────────────────────────────────────────────────────────────
  {
    food_name: 'Cappuccino', category: 'Beverages', price: 281,
    aliases: [
  ...
  {
    food_name: 'Coke', category: 'Beverages', price: 335,
    aliases: [
  ...
  {
    food_name: 'Cold Coffee', category: 'Beverages', price: 320,
    aliases: [
  ...
  {
    food_name: 'Hot Chocolate', category: 'Beverages', price: 94,
    aliases: [
  ...
  {
    food_name: 'Latte', category: 'Beverages', price: 125,
    aliases: [
      'latte', 'लाटे', 'लट्टे', 'cafe latte', 'milk coffee', 'दूध वाली कॉफी',
    ],
  },
  {
    food_name: 'Lemon Soda', category: 'Beverages', price: 246,
    aliases: [
  ...
  {
    food_name: 'Mango Shake', category: 'Beverages', price: 170,
    aliases: [
  ...
  {
    food_name: 'Mint Mojito', category: 'Beverages', price: 288,
    aliases: [
  ...
  {
    food_name: 'Pepsi', category: 'Beverages', price: 81,
    aliases: [
      'pepsi', 'पेप्सी', 'soda', 'सोडा', 'cold drink', 'ठंडा पेप्सी',
    ],
  },
  {
    food_name: 'Strawberry Shake', category: 'Beverages', price: 105,
    aliases: [
  ...
  // ── Breads ─────────────────────────────────────────────────────────────────
  {
    food_name: 'Aloo Paratha', category: 'Breads', price: 218,
    aliases: [
  ...
  {
    food_name: 'Butter Naan', category: 'Breads', price: 329,
    aliases: [
  ...
  {
    food_name: 'Paneer Paratha', category: 'Breads', price: 188,
    aliases: [
  ...
  {
    food_name: 'Tandoori Roti', category: 'Breads', price: 329,
    aliases: [
  ...
  // ── Burgers ────────────────────────────────────────────────────────────────
  {
    food_name: 'Cheese Burger', category: 'Burgers', price: 177,
    aliases: [
  ...
  {
    food_name: 'Veg Burger', category: 'Burgers', price: 135,
    aliases: [
  ...
  // ── Desserts ───────────────────────────────────────────────────────────────
  {
    food_name: 'Brownie', category: 'Desserts', price: 314,
    aliases: [
  ...
  {
    food_name: 'Chocolate Lava Cake', category: 'Desserts', price: 371,
    aliases: [
  ...
  {
    food_name: 'Falooda', category: 'Desserts', price: 345,
    aliases: [
      'falooda', 'फालूदा', 'faluda', 'rose falooda', 'फालूदा कुल्फी',
    ],
  },
  {
    food_name: 'Ice Cream Chocolate', category: 'Desserts', price: 200,
    aliases: [
  ...
  {
    food_name: 'Ice Cream Vanilla', category: 'Desserts', price: 82,
    aliases: [
  ...
  // ── Fries ──────────────────────────────────────────────────────────────────
  {
    food_name: 'Peri Peri Fries', category: 'Fries', price: 373,
    aliases: [
  ...
  // ── Light Course ───────────────────────────────────────────────────────────
  {
    food_name: 'Club Sandwich', category: 'Light Course', price: 269,
    aliases: [
      'club sandwich', 'क्लब सैंडविच', 'club sandwitch', 'sandwich',
      'सैंडविच', 'veg club sandwich',
    ],
  },
  {
    food_name: 'Hakka Noodles', category: 'Light Course', price: 115,
    aliases: [
  ...
  {
    food_name: 'Paneer Momos', category: 'Light Course', price: 298,
    aliases: [
  ...
  {
    food_name: 'Schezwan Noodles', category: 'Light Course', price: 275,
    aliases: [
  ...
  {
    food_name: 'Vada Pav', category: 'Light Course', price: 311,
    aliases: [
  ...
  {
    food_name: 'Veg Cutlet', category: 'Light Course', price: 389,
    aliases: [
  ...
  {
    food_name: 'Veg Manchurian', category: 'Light Course', price: 329,
    aliases: [
  ...
  {
    food_name: 'Veg Momos', category: 'Light Course', price: 400,
    aliases: [
  ...
  {
    food_name: 'Veg Sandwich', category: 'Light Course', price: 272,
    aliases: [
      'veg sandwich', 'वेज सैंडविच', 'vegetable sandwich', 'plain sandwich',
      'सैंडविच', 'sandwitch', 'veg sandwitch',
    ],
  },
  {
    food_name: 'Samosa', category: 'Light Course', price: 269,
    aliases: [
  ...
  // ── Main Course ────────────────────────────────────────────────────────────
  {
    food_name: 'Chole Bhature', category: 'Main Course', price: 103,
    aliases: [
  ...
  {
    food_name: 'Dal Makhani', category: 'Main Course', price: 109,
    aliases: [
  ...
  {
    food_name: 'Idli Sambar', category: 'Main Course', price: 346,
    aliases: [
      'idli sambar', 'इडली सांभर', 'idli', 'इडली', 'sambar idli',
      'south indian idli', 'idly sambar', 'idli sambhar',
    ],
  },
  {
    food_name: 'Masala Dosa', category: 'Main Course', price: 227,
    aliases: [
      'masala dosa', 'मसाला डोसा', 'masala dose', 'masala dosa crispy',
      'aloo dosa', 'आलू डोसा', 'dosa', 'डोसा',
    ],
  },
  {
    food_name: 'Paneer Butter Masala', category: 'Main Course', price: 240,
    aliases: [
  ...
  {
    food_name: 'Pav Bhaji', category: 'Main Course', price: 389,
    aliases: [
  ...
  {
    food_name: 'Plain Dosa', category: 'Main Course', price: 344,
    aliases: [
      'plain dosa', 'सादा डोसा', 'sada dosa', 'dosa', 'डोसा',
      'crispy dosa', 'plain dose',
    ],
  },

  // ── Pasta & Italian ────────────────────────────────────────────────────────
  {
    food_name: 'Pasta Alfredo', category: 'Pasta & Italian', price: 268,
    aliases: [
  ...
  {
    food_name: 'Pasta Arrabiata', category: 'Pasta & Italian', price: 366,
    aliases: [
  ...
  // ── Pizza ──────────────────────────────────────────────────────────────────
  {
    food_name: 'Corn Pizza', category: 'Pizza', price: 217,
    aliases: [
  ...
  {
    food_name: 'Farmhouse Pizza', category: 'Pizza', price: 86,
    aliases: [
  ...
  {
    food_name: 'Margherita Pizza', category: 'Pizza', price: 242,
    aliases: [
  ...
  {
    food_name: 'Mushroom Pizza', category: 'Pizza', price: 154,
    aliases: [
      'mushroom pizza', 'मशरूम पिज़्ज़ा', 'mushroom wala pizza',
      'खुम्ब पिज़्ज़ा', 'mushroom',
    ],
  },
  {
    food_name: 'Paneer Pizza', category: 'Pizza', price: 123,
    aliases: [
  ...
  {
    food_name: 'Veg Pizza', category: 'Pizza', price: 290,
    aliases: [
      'veg pizza', 'वेज पिज़्ज़ा', 'pizza', 'पिज़्ज़ा', 'पिज्जा',
      'vegetable pizza', 'veg wala pizza', 'veggie pizza',
      // Hindi misspellings / phonetic variants:
      'पिज्जा', 'पीज़ा', 'piza', 'pizaa',
    ],
  },

  // ── Rice & Biryani ─────────────────────────────────────────────────────────
  {
    food_name: 'Kadhi Chawal', category: 'Rice & Biryani', price: 185,
    aliases: [
      'kadhi chawal', 'कढ़ी चावल', 'kadhi rice', 'curry chawal',
      'कढ़ी', 'kadhi', 'yellow kadhi',
    ],
  },
  {
    food_name: 'Rajma Chawal', category: 'Rice & Biryani', price: 146,
    aliases: [
  ...
  {
    food_name: 'Fried Rice', category: 'Rice & Biryani', price: 80,
    aliases: [
  ...
  {
    food_name: 'Paneer Biryani', category: 'Rice & Biryani', price: 81,
    aliases: [
  ...
  {
    food_name: 'Veg Biryani', category: 'Rice & Biryani', price: 368,
    aliases: [
  ...
  // ── Soups ──────────────────────────────────────────────────────────────────
  {
    food_name: 'Sweet Corn Soup', category: 'Soups', price: 143,
    aliases: [
  ...
  {
    food_name: 'Tomato Soup', category: 'Soups', price: 281,
    aliases: [
  ...
  {
    food_name: 'Veg Soup', category: 'Soups', price: 203,
    aliases: [
  ...
  // ── Starters ───────────────────────────────────────────────────────────────
  {
    food_name: 'Cheese Balls', category: 'Starters', price: 298,
    aliases: [
  ...
  {
    food_name: 'Chilli Paneer', category: 'Starters', price: 315,
    aliases: [
  ...
  {
    food_name: 'Garlic Bread', category: 'Starters', price: 86,
    aliases: [
  ...
  {
    food_name: 'Greek Salad', category: 'Starters', price: 341,
    aliases: [
  ...
  {
    food_name: 'Kachori', category: 'Starters', price: 118,
    aliases: [
  ...
  {
    food_name: 'Nachos', category: 'Starters', price: 136,
    aliases: [
  ...
  {
    food_name: 'Onion Rings', category: 'Starters', price: 172,
    aliases: [
  ...
  {
    food_name: 'Spring Rolls', category: 'Starters', price: 160,
    aliases: [
  ...
  // ── Wraps ──────────────────────────────────────────────────────────────────
  {
    food_name: 'Falafel Wrap', category: 'Wraps', price: 203,
    aliases: [
      'falafel wrap', 'फलाफेल रैप', 'falafel roll', 'falafel',
      'फलाफेल', 'arabic wrap', 'middle eastern wrap',
    ],
  },
  {
    food_name: 'Paneer Wrap', category: 'Wraps', price: 202,
    aliases: [
  ...
  {
    food_name: 'Veg Wrap', category: 'Wraps', price: 335,
    aliases: [
...
// ─── Lookup helper ─────────────────────────────────────────────────────────────
// Returns the canonical menu item if the spoken text matches any alias.
/**
 * @param {string} spoken
 * @returns {MenuAlias | undefined}
 */
export function findMenuItemByAlias(spoken) {
  const normalized = spoken.trim().toLowerCase();
  return MENU_ALIASES.find(item =>
    item.aliases.some(alias => normalized.includes(alias) || alias.includes(normalized))
  );
}

// ─── Full alias flat list (for backend fuzzy matching) ─────────────────────────
// Export as JSON-friendly structure for Python backend consumption if needed.
/** @type {Record<string, string>} */
export const ALIAS_MAP = Object.fromEntries(
  MENU_ALIASES.flatMap(item =>
    item.aliases.map(alias => [alias, item.food_name])
  )
);